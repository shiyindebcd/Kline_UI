...
"")
        ...
        self.Btn_draw_line_order.setMinimumSize(QSize(80, 40))
...
"}")
        ...
        self.Btn_draw_line_style = QPushButton(self.frame_9)
        self.Btn_draw_line_style.setObjectName(u"Btn_draw_line_style")
        self.Btn_draw_line_style.setMinimumSize(QSize(80, 40))
...
"}")
        ...
        self.horizontalLayout_9.addWidget(self.Btn_draw_line_style)
...
"\u949f", None))
        ...
        self.label_26.setText(QCoreApplication.translate("Form", u"\u81ea\u9009\u5408\u7ea6\u5217\u8868\uff1a", None))
    # retranslateUi
